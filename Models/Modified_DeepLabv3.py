...
#This model is an implementation of the model from the paper "A Real-time Fire Segmentation Method Based on A Deep Learning Approach".
#The model was taken from this github repository: https://github.com/maidacundo/real-time-fire-segmentation-deep-learning/blob/main/Fire%20Segmentation%20Pipeline.ipynb
