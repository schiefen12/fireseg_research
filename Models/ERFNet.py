...
#This is an implementation of the model from the "ERFNet: Efficient Residual Factorized ConvNet for Real-time Semantic Segmentation" paper.
#The model was taken from this github repository: https://github.com/Eromera/erfnet_pytorch/blob/master/train/erfnet.py
